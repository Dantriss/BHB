...
<c:forEach var="yp" items="${yplist}">
		...
		<tr>
			...
			<input type="checkbox"
				name="check1" id="check81" class="check" 
				value="${yp.num}"></td>
			<td class="td_default" width="80" align="center">${yp.num}</td>
			<td class="td_default" width="80">
			<img src="images/${yp.gImage}.jpg" border="0" align="center"
				width="80" alt="img"/></td>
...
<c:forEach var="mp" items="${mplist}">
		...
		<tr>
			...
			따라서 value에 삭제할 num값을 설정한다. -->
			<input type="checkbox"
				name="check2" id="check81" class="check" 
				value="${mp.num}"></td>
			<td class="td_default" width="80" align="center">${mp.num}</td>
			<td class="td_default" width="80">
			<img src="images/${mp.gImage}.jpg" border="0" align="center"
				width="80" alt="img"/></td>
			<td class="td_default" width="300" style='padding-left: 30px' align="center">
			${mp.address}
