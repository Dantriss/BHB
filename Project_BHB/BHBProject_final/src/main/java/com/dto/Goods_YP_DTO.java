...
public Goods_YP_DTO(int gCode, int gPrice, String address, String location, String area, String room, int fee,
...
public String toString() {
	return "Goods_YP_DTO [gCode=" + gCode + ", gPrice=" + gPrice + ", address=" + address + ", location=" + location
			+ ", area=" + area + ", room=" + room + ", fee=" + fee + ", floor=" + floor + ", elv=" + elv + ", parking="
			+ parking + ", build=" + build + ", gImage1=" + gImage1 + ", lessorid=" + lessorid + ", gImage2=" + gImage2
			+ ", gImage3=" + gImage3 + ", gImage4=" + gImage4 + ", gImage5=" + gImage5 + "]";
}
public int getgCode() {
	return gCode;
}
