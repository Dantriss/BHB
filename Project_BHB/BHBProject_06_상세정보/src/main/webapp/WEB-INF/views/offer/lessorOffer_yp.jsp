...
<h4>사진 등록</h4>
    <div class="IMAGE" id="addPhoto">
        <tr>
          <td>
           <input type="text" name="gImage1" id="gImage1" placeholder="사진1" /> 
           <input type="text" name="gImage2" id="gImage2" placeholder="사진2"/> 
           <input type="text" name="gImage3" id="gImage3" placeholder="사진3"/> 
           <input type="text" name="gImage4" id="gImage4" placeholder="사진4"/> 
 ...
 <h3>상세정보</h3>
   ...
   <tr>
	...
	<tr>
		<th>준공날짜</th>
		<td class="BUILD">
		<input type="text" class="text" name="build" id="bulid" />
